...
Firstly the data are split into train (dataTrain) and test (dataTest) data to test the model accuracy (out of sample error). Cross-validation will be done for the different models based on this split.
...
```
Very good prediction. Out of sample Accuracy is very high (99.5%). The confusion matrix also keeps most of the values of the diagonal which shows the a good relation between predicted and actual values.
